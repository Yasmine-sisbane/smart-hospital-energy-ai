# =========================
# train_xgboost_t60.py
# Modèle XGBoost pour prédiction énergétique T+1h
...
TARGET_NORMAL_COL = "target_normal_energy_t60"
TARGET_OBSERVED_COL = "target_observed_energy_t60"
TARGET_ANOMALY_COL = "target_anomaly_t60"

MODEL_PATH = OUTPUT_DIR / "xgb_energy_model_t60.joblib"
COLUMNS_PATH = OUTPUT_DIR / "xgb_model_columns_t60.joblib"
THRESHOLDS_PATH = OUTPUT_DIR / "xgb_anomaly_thresholds_t60.joblib"

METRICS_PATH = RESULTS_DIR / "xgb_metrics_t60.csv"
TEST_RESULTS_PATH = RESULTS_DIR / "xgb_test_predictions_t60.csv"
THRESHOLD_REPORT_PATH = RESULTS_DIR / "xgb_threshold_report_t60.csv"
...
def evaluate_thresholds(train_abs_error, test_abs_error_observed, y_test_anomaly):
    ...
    print("\n===== Recherche seuils anomalies T+1h =====")
...
print("Après création cible T+1h :", df.shape)
...
print("\n===== Détection anomalies T+1h avec seuil warning =====")
...
print("\nTop 15 features importantes T+1h :")
...
test_results["prediction_normal_energy_t60"] = y_pred_normal
test_results["residual_observed_t60"] = test_residual_observed
test_results["abs_error_observed_t60"] = test_abs_error_observed
test_results["predicted_anomaly_t60"] = y_pred_anomaly
test_results["predicted_severity_t60"] = [
...
print("\nEntraînement XGBoost T+1h terminé avec succès.")